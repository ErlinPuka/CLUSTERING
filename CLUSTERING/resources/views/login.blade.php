                ...
                <div id="auth-left">
                    ...
                    <form action="{{ route ('login') }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" value="{{ Session::get('email') }}" name="email" class="form-control form-control-xl" placeholder="Email">
                    ...
                    <div class="text-center text-lg fs-4 mt-3">
                        <p class="text-gray-600">Tidak punya akun? <a href="{{ route ('register') }}" class="font-bold">Sign
                                up</a>.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 d-none d-lg-block">
                <div id="auth-right" class="d-flex justify-content-center align-items-center h-100">
                    <div class="text-center">
                        <img src="{{ asset('images/sikka.png') }}" alt="Logo">
                    </div>
                </div>
            </div>
        </div>
